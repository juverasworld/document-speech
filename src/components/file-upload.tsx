...
//           console.log("[v0] Processing PDF with pdf2md library...")

//           const result = await pdf2md.default(arrayBuffer)

//           console.log("[v0] Successfully extracted text from PDF:", result.substring(0, 100) + "...")
...
//     } catch (err) {
//       console.error("[v0] File extraction error:", err)
...
//         {...getRootProps()}
//         className={cn(
//           "border-2 border-dashed cursor-pointer transition-colors p-8 text-center",
...
//           <p className="text-sm text-primary">Processing document...</p>
//         </div>
//       )}
//     </div>
//   )
